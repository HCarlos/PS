...
<body class="container">
  ...
  <script type="text/javascript">
      ...
      try {
            ...
            var trackOutboundLink = function(varU) {
               ga('send', 'event', 'LoginUser-'+varU, 'click', 'Login', {'hitCallback':
                 function () {}
               });
            }
                ...
                <div class="inner container">
                    <div class="span12 ">
                        <div class="banner-logo ">
                            <img src="/images/web/plataforma-gestion-1-logo.png" width="486" height="145" alt="" />
...
<!--                                     <div class="toolbar clearfix green">
                                        <div>
