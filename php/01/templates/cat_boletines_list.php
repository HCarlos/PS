				...
				<table aria-describedby="sample-table-2_info" id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
					...
					<thead>
						<tr role="row">
							...
							<th aria-label="pdf: activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="sample-table-2" tabindex="1" role="columnheader" class="sorting">Boletin</th>
...
jQuery(function($) {
	...
	function fillTable(){
		...
		var nc = "u="+localStorage.nc+"&categoria_pdf=0";
	...
	function getPropBoletin(IdBoletin){
		...
		$.post(obj.getValue(0) + "cat-boletines-prop/", {
				user: nc,
				idpdf: IdBoletin
			},
			function(html) {
