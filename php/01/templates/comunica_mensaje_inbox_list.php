				...
				<table aria-describedby="sample-table-2_info" id="tblComMenAlu2" class="table table-striped table-bordered table-hover dataTable">
					...
					<thead>
						<tr role="row">
							...
							<th aria-label="archivos: to sort column ascending" style="width: 10px;" aria-controls="tblComMenAlu2" tabindex="4" role="columnheader" class="sorting center">ARCH</th>
