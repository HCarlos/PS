    ...
    <div class="widget-header widget-header-blue widget-header-flat">
        ...
        <div class="widget-toolbar no-border">
            ...
            <div class="widget-toolbar">
                <button  type="button" class="btn btn-minier btn-primary btn-app radius-4 marginTop025em closeFormUploadPAIALU00 " >
            ...
            <div class="widget-toolbar no-border">
                <button  type="button" class="btn btn-minier btn-success btn-app radius-4 marginTop025em" id="btnViewPAIAluCal00" >
