...
<div class="tabbable">
	...
	<form id="frmDataPDF" role="form">
		...
		<div class="tab-content">
			...
			<div id="general" class="tab-pane active">
				<table>
					...
					<tr>
						<td>
			    			<label for="pdf" class="control-label">Calendario (pdf)</label>
                    	</td>	
						<td>
	    ...
	    <input type="hidden" name="categoria_pdf" id="categoria_pdf" value="1">
            ...
            $("#preloaderPrincipal").show();
                ...
                $.ajax({
                    ...
                    success: function(json){
                        ...
                        if (json.status=="OK"){
                            alert( json.message );
                            stream.emit("cliente", {mensaje: "PLATSOURCE-UPLOAD_CALENDARIO-PROP-"+idpdf});
							$("#preloaderPrincipal").hide();
