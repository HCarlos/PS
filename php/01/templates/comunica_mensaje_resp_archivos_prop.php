...
$param1 = md5($user.$idcommensajedestinatario);

?>
<div class="widget-box">
    <div class="widget-header widget-header-blue widget-header-flat">
        <i class="icon-circle green"></i> <strong id="spIdtarea"><?php echo $idcommensajedestinatario; ?></strong>: <b class="text-success">Nuevo Archivo</b> 
    </div>
        ...
        <div class="widget-main">
            ...
            <div class="row-fluid">
                ...
                <form id="frmFURA01" role="form">
                    ...
                    <input type="hidden" name="idcommensajedestinatario" id="idcommensajedestinatario" value="<?php echo $idcommensajedestinatario; ?>">
                    <input type="hidden" name="user" id="user" value="<?php echo $user; ?>">
                    <input type="hidden" name="v3" id="v3" value="<?php echo $param1; ?>">
                    <div class="form-group w96" style='margin-right: 3em; margin-top: 1em;'>
                        ...
                        <button type="submit" class="btn btn-primary pull-right" style='margin-right: 4em;' id="uploadingFileComMen02"><i class="icon-cloud-upload"></i>Subir</button>
                    </div>
...
jQuery(function($) {
    ...
    $("#frmFURA01").unbind("submit");
    $("#frmFURA01").on("submit",function(event){
        event.preventDefault();

        if ( validForm() ) {

                $("#uploadingFileComMen02").html('<i class="fa fa-refresh fa-spin"> </i> <i>Subiendo Archivo</i>');

                $("#preloaderPrincipal").show();

                $("#uploadingFileComMen02").prop('disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(json){
                        ...
                        if (json.status=="OK"){
                            ...
                            $("#uploadingFileComMen02").prop('disabled', false);
