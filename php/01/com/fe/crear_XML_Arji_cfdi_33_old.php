...
$cadena_xml.='<cfdi:Comprobante xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:iedu="http://www.sat.gob.mx/iedu" Version="3.3" serie="'.$serie.'" folio="'.$folio.'" Fecha="'.$fecha.'" sello="'.$sello.'" formaDePago="PUE" NoCertificado="'.$num_certificado.'" Certificado="'.$certificado_texto.'" subTotal="'.number_format($total, 2, '.','').'" TipoCambio="1.00" Moneda="MXN" total="'.number_format($total_cadena, 2, '.','').'" tipoDeComprobante="I" metodoDePago="'.$metodo_pago.'" LugarExpedicion="'.$codigo_postal_emisor.'" FechaFolioFiscalOrig="'.$fecha.'" MontoFolioFiscalOrig="'.number_format($total_cadena, 2, '.','').'" xsi:schemaLocation="http://www.sat.gob.mx/cfd/3  http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd http://www.sat.gob.mx/iedu http://www.sat.gob.mx/sitio_internet/cfd/iedu/iedu.xsd" xmlns:cfdi="http://www.sat.gob.mx/cfd/3">'."\r\n";
$cadena_xml.='<cfdi:Emisor Rfc="'.trim($rfc_emisor).'" nombre="'.$razon_social_emisor.'" RegimenFiscal="603" />'."\r\n";
$cadena_xml.='<cfdi:Receptor Rfc="AAAA010101AAA" nombre="'.trim($razon_social).'" UsoCFDI="G01" />'."\r\n";
