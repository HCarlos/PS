...
<title>Reporte de Calificaciones en Inglés - Kinder Arjí</title>
...
$fl=$miCal;
$arrIdGruMat = array();
$mats = $f->getCombo(1,"idgrupo=".$idgrupo."&idciclo=".$idciclo,0,0,24,' and idioma = 1  and padre > 0 and orden_historial <= 100 order by orden_historial asc '); 
...
$fileout= "reporte-calif-kinder-ing-arji-eval-".$numeval.'-'.$ti.".xlsx";
