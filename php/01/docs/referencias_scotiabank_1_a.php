...
$pdf->Cell(10,$pdf->nFont,'4080','',1,'L');
$pdf->SetFont('Times','B',12);
$pdf->Image('../../../images/web/scotiabanl-logo-444-80.gif',150,18,44.4,8);
...
$ref = $A->ref_SCOTIA(
		$edocta[0]->idciclo, 
		$edocta[0]->clave_nivel, 
		$idfamilia, 
		$edocta[0]->idalumno, 
		$edocta[0]->idconcepto, 
		$edocta[0]->num_pago, 
		$edocta[0]->total, 
		$edocta[0]->vencimiento,
		1
		);


$pdf->Cell(22,6,$ref,'',1,'L');

$pdf->Cell(22,6,$edocta[0]->total,'',1,'L');
*/
