...
class PDF_Diag extends PDF_Sector {
    ...
    function Header(){ 
		...
		$this->Cell(100,6,utf8_decode("RESUMEN DE BECAS Y DESCUENTOS POR NIVELES Y CONCEPTOS"),'',1,'L');
	    if ($this->tipoBeca != 0){
		    $this->setX(40);
			$this->SetFont('Arial','B',12);
			$this->Cell(100,6,utf8_decode($this->cTBeca),'',1,'L');
		}
	    $this->setX(40);
...
$pdf->cTBeca = $ctipobeca;
$pdf->tipoBeca = intval($tipoBeca);
...
$rs = $fP->getQueryPDO(18,$data,0,0,0,array(),"",1);
