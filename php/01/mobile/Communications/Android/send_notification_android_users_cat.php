...
foreach ($rt as $i => $value) {
	try{
		...
		// if ( intval($rt[$i]->iduser) == 4040 ) {
			...
			$cad2 = "user=$user&iddevice=".$rt[$i]->iddevice."&titulo=$titulo&mensaje=$mensaje&from_module=PlatSource&respuesta_envio=".$cad."&version_mobile=".$version_mobile."&user_sender=".$user_sender;
